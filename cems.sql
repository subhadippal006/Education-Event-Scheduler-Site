...
('4MW22CS005', 'Anu', 'CSE', 5, 'annapoornaba@gmail.com', '8123300011', 'SMVITM'),
('4MW22CS012', 'BHAVANA', 'cse', 5, 'BHAVANA@GMAIL.COM', '9934736623', 'SMVITM'),
('4MW22CS022', 'Kavya', 'cse', 5, 'Kavya@gmail.com', '7888387323', 'SMVITM'),
('4MW22CS025', 'Mythri', 'ISE', 5, 'mythri@saividya.ac.in', '8998848488', 'SMVITM'),
('4MW22CS034', 'Prajwal', 'cse', 5, 'prajwal@gmail.com', '9858787438', 'SMVITM'),
('4MW22IS045', 'Prathiksha', 'ISE', 5, 'prathi@gmail.com', '7897854345', 'SMVITM');
...
--
ALTER TABLE `event_info`
  MODIFY `event_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=140008;
...
--
ALTER TABLE `staff_coordinator`
  MODIFY `stid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=140008;

--
-- AUTO_INCREMENT for table `student_coordinator`
--
ALTER TABLE `student_coordinator`
  MODIFY `sid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=140008;
COMMIT;
